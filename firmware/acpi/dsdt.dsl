 ...
 *
 * Disassembly of dsdt.dat, Wed Aug 26 14:38:43 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001725E (94814)
 *     Revision         0x02
 *     Checksum         0x0F
 *     OEM ID           "MSFT  "
 *     OEM Table ID     "MSFT    "
...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MSFT    ", 0x00000000)
{
    ...
    Name (SS3, Zero)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x8BE8F000, 0x077C)
